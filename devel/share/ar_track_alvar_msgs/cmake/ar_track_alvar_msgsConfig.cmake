...
if("TRUE" STREQUAL "TRUE")
  set(ar_track_alvar_msgs_SOURCE_PREFIX /root/catkin_ws/src/limo_marker/ar_track_alvar/ar_track_alvar_msgs)
...
if(NOT "/root/catkin_ws/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ar_track_alvar_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/catkin_ws/src/limo_marker/ar_track_alvar/ar_track_alvar_msgs/${idir}'.  ${_report}")
    endif()
